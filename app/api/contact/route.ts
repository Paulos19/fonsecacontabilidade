...
export async function POST(req: Request) {
    try {
      ...
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #050505; color: #ffffff; padding: 40px; border-radius: 12px; border: 1px solid #1a1a1a;">
        <h2 style="color: #00ffaa; margin-bottom: 24px; font-weight: 300;">Olá, ${name}!</h2>
        ...
        <div style="background-color: #0a0a0a; padding: 24px; border-radius: 8px; margin-top: 32px; border-left: 4px solid #00ffaa;">
