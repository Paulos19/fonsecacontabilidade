...
const PaperShaderBackground = dynamic(
    () => import("@/components/ui/background-paper-shaders"),
    { ssr: false }
);
...
export function MetricsSection() {
    return (
        <section className="w-full text-white relative h-full" id="metricas">
            <PaperShaderBackground>
                <div className="pt-32 pb-24 max-w-7xl mx-auto w-full px-6 lg:px-10 flex flex-col gap-24">
