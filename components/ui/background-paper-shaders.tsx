        ...
        <div className="relative w-full h-full overflow-hidden">
            <div className="absolute inset-0 z-0 bg-[#050505] pointer-events-none">
                <Canvas camera={{ position: [0, 0, 2] }}>
                    <ShaderPlane position={[0, 0, 0]} color1="#2A7F59" color2="#37A674" />
                </Canvas>
            </div>
...
export function ShaderPlane({
    position,
    color1 = "#2A7F59", // Verde escuro
    color2 = "#37A674", // Verde fonseca
}: {
...
export function EnergyRing({
    ...
    return (
        <mesh ref={mesh} position={position}>
            ...
            <meshBasicMaterial color="#37A674" transparent opacity={0.6} side={THREE.DoubleSide} />
        </mesh>
    )
}
