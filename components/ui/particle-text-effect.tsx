...
export function ParticleTextEffect({ words = DEFAULT_WORDS }: ParticleTextEffectProps) {
    ...
    const animate = () => {
        ...
        // Background with motion blur - keeping it transparent/dark here
    ...
    useEffect(() => {
        ...
        // Allow it to be somewhat responsive or just fix inner canvas size and css scale it
        canvas.width = 1000
        canvas.height = 500
    ...
    }, []) // Ignorando dependência words para não reiniciar animação sem motivo
